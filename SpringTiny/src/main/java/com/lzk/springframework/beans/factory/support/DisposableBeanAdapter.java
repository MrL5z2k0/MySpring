...
import com.lzk.springframework.beans.factory.DisposableBean;
...
/**
 * @author kasuo
 * @date 2021/8/18 6:24 下午
 * 1、目前有实现接口 DisposableBean、配置信息 destroy-method，两种方式。而这两种方式的销毁动作是由 AbstractApplicationContext 在注册虚拟机钩子后看，虚拟机关闭前执行的操作动作。
